...
const deleteDepartment = (id, name) =>{
  ...
  alerta.fire({
    title:'¿Seguro que desea eliminar el departamento '+name+'?',
    icon: 'question',
        ...
        <div class="py-12">
            <div class="bg-white grid v-screen place-items-center">
                <div class="mt-3 mb-3 flex">
                  ...
                  :class="'px-4 py-2 bg-gray-800 text-white border rounded-md font-semibold'">
                    <i class="fa-solid fa-plus-circle"></i> Add Department</Link>
                </div>
            </div>
            <div class="bg-white grid v-screen place-items-center">
                  ...
                  <tr v-for="dep, i in departments" :key="dep.id">
                    ...
                    <td class="border border-gray-400 px-4 py-4">
                      <Link :href="route('departments.edit', dep.id)" 
                        :class="'px-4 py-2 bg-yellow-400 hover:bg-yellow-500 border rounded-md font-semibold'">
                        <i class="fa-solid fa-edit"></i></Link>
                    </td>
                    <td class="border border-gray-400 px-4 py-4">
