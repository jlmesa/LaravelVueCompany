...
const save = () => {
  if(operation.value === 1){
    form.post(route('employees.store'),{
      onSuccess: () => { ok('Empleado registrado exitosamente!')}
    });
  }else{
    form.put(route('employees.update', id.value),{
      onSuccess: () => { ok('Empleado actualizado exitosamente!')}
    });
  }
}
...
const deleteEmployee = (id, name) =>{
  ...
  alerta.fire({
    title:'¿Seguro que desea eliminar al empleado '+name+'?',
    icon: 'question',
    ...
    if(result.isConfirmed){
      ...
      onSuccess: () => { ok('Empleado eliminado exitosamente!')}
      });
    }
  });
}
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="bg-white grid v-screen place-items-center">
                <div class="mt-3 mb-3 flex">
                  <PrimaryButton @click="openModal(1)">
                    <i class="fa-solid fa-plus-circle"></i> Add Employee</PrimaryButton>
                </div>
            </div>
            <div class="bg-white grid v-screen place-items-center overflow-x-auto">
              <table class="table-auto border border-gray-400 text-center">
                <thead>
                  ...
                  <tr v-for="emp, i in employees.data" :key="emp.id">
                    ...
                    <td class="border border-gray-400 px-2 py-2">
                      <WarningButton @click="openModal(2, emp.name, emp.email, emp.phone, emp.department_id, emp.id)">
                        <i class="fa-solid fa-edit"></i></WarningButton>
                    </td>
                    <td class="border border-gray-400 px-2 py-2">
            ...
            <div class="bg-white grid v-screen place-items-center mt-2">
        ...
        <Modal :show="modal" @close="closeModal">
          ...
          <div class="p-3 mt-6">
            ...
            <div class="p-3 text-center">
                ...
                @click="closeModal"> Cancelar</SecondaryButton>
            </div>
        </Modal>
    </AuthenticatedLayout>
</template>